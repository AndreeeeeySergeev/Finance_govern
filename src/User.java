...
public class User {
    ...
    public void authorization() {
        ...
        public void createUser() {
            System.out.print("Придумайте Логин: "); // to do сделать форму ввода только на англ + доп.символы
            String login = input.next().trim();
            if (login.length() < 5 || login.length() > 15) {
                System.out.println("Логин должен быть от 5 до 15 символов");
                createUser();
            }
            System.out.print("Придумайте пароль: "); // to do сделать форму ввода только на англ + доп.символы
